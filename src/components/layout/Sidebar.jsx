          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 px-3 py-1 mt-2 bg-white/15 hover:bg-white/25 text-white rounded-full text-xs font-medium transition-colors whitespace-nowrap"
